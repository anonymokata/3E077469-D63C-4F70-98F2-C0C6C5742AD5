...
#def lcm_globals_set(arg_glbl_tpls):
	...
	#if arg_glbl_tpls[1] == "":					# if value was empty stirng
	#	rn_lcm_ch_to_cli = None					# then we actually wanted a NULL
	#else:
	#	rn_lcm_ch_to_cli = arg_glbl_tpls[1]		# set global values
	
	#if arg_glbl_tpls[2] == "":					# if value was empty stirng
	#	rn_lcm_provider = None					# then we actually wanted a NULL
	#else:
